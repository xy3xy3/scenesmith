...
SIZE_PROFILES: tuple[SizeProfile, ...] = (
    ...
    SizeProfile(
        name="remote_control",
        patterns=(r"\bremote\b", r"\bremote control\b"),
        width=DimensionRange(0.12, 0.28),
        depth=DimensionRange(0.035, 0.08),
        height=DimensionRange(0.008, 0.035),
    ),
    SizeProfile(
        name="mouse",
    ...
    SizeProfile(
        name="coaster",
        patterns=(r"\bcoaster(s)?\b", r"\bdrink mat(s)?\b"),
        width=DimensionRange(0.07, 0.13),
        depth=DimensionRange(0.07, 0.13),
        height=DimensionRange(0.004, 0.025),
        footprint_swappable=True,
    ),
    SizeProfile(
        name="cutlery",
        ...
        width=DimensionRange(0.015, 0.06),
        depth=DimensionRange(0.12, 0.28),
        height=DimensionRange(0.003, 0.025),
        footprint_swappable=True,
    ),
)
