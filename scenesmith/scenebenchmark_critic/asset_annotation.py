...
def _build_annotation_prompt(
    *,
    ...
    return (
        ...
        "chairs face desks/tables. For beds, wardrobes, cabinets, dressers, "
        "nightstands, sideboards, and other large storage/sleeping furniture, "
        "prefer adding `back_against_wall` or `side_or_back_against_wall` when "
        "that matches the asset's normal intended placement or installation prior. "
        "Do not omit those wall-backed dependencies just because the current scene "
        "placement looks slightly detached from a wall; classify the asset's "
        "typical function/install pattern, not whether this scene already placed "
        "it correctly. Ignore small-object orientation dependencies unless they "
        "are explicitly visible and important.\n"
